...
/**
 * Servlet implementation class DoEditUsersServlet
 */
@WebServlet("/doeditUsers")
public class DoEditUsersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoEditUsersServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
	       ...
	       try {
               DBUtils.updateUsuario(conn, user);
